            ...
            <div className='absolute w-full top-[-100px] z-10'>
                ...
                >
                    ...
                    <div className='flex'>
                        {hotels && hotels.map((h) => {
                            return (
                                <div className='w-57 h-70 pb-5 m-2 bg-white rounded-md shadow-[0_5px_10px_rgba(0,0,0,0.2)] cursor-pointer'>
                                    <img src={h.image} alt='hotelImage' className='object-cover h-[70%] rounded-t-md' />
